...
// ─── Main Hero Section ────────────────────────────────────────────────────────
export default function FloatingShirt2() {
        ...
        <>
            ...
            <main>
                ...
                >
                    ...
                    <div
                        className="absolute inset-0 flex flex-col items-end justify-center pointer-events-none select-none z-0 pr-6"
                        style={{
                    ...
                    >
                        <TextRow text="MORE " scrollY={scrollY} triggerAt={0} speed={0.0} />
                        <TextRow text="OF  OUR" scrollY={scrollY} triggerAt={60} speed={0.0} />
                        <TextRow text="DEDICATED     " scrollY={scrollY} triggerAt={120} speed={0.0} />
                        <TextRow text="    AND FUN WORK" scrollY={scrollY} triggerAt={120} speed={0.0} />
                    </div>

                    {/* ── Floating shirt (parallax — moves slower than page) ── */}
                    <div
                        className="absolute inset- pt-150 flex items-center justify-center z-10 pointer-events-none"
                        style={{
                    ...
                    >
                        ...
                        >
                            ...
                            <img
                                src="https://res.cloudinary.com/dqw2fvojt/image/upload/v1774610046/765c4727-a9bd-4b5f-851b-a810f6f615de_removalai_preview_ohgepk.png"
